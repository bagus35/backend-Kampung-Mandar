  ...
  <div class="col-md-12">
    <div class="tile">
      <div class="title-page">
        <h3 class="tile-title"><i class="fa fa-road" aria-hidden="true"></i> ADD DATA PERAHU</h3>
        <div class="nav-back">
      ...
      <div class="tile-body">
        <form id="form-add" method="post" role="form" class="was-validated" action="<?php echo base_url();?>perahu/save" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_perahu" id="nama_perahu" required autofocus>
                <div class="valid-feedback"><i>*valid</i> </div>
                <div class="invalid-feedback"><i>*required</i> </div>
              </div>
            </div>
			...
			<div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control ribuan" name="lebar_perahu" id="lebar_perahu" required>
                <div class="valid-feedback"><i>*valid</i> </div>
                <div class="invalid-feedback"><i>*required</i> </div>
              </div>
            </div>
			<div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control ribuan" name="panjang_perahu" id="panjang_perahu" required>
                <div class="valid-feedback"><i>*valid</i> </div>
                <div class="invalid-feedback"><i>*required</i> </div>
              </div>
            </div>
...
<script type="text/javascript">
	...
	$('#kelompok').addClass('radius-bawah');
	$('#nelayan').addClass('radius-atas');
	...
	var table = $('#table').DataTable({
		...
		"ajax": {
			"url": "<?php echo site_url('perahu/ajax_list')?>",
			"type": "POST"
		},
		"columnDefs": [{
	...
	function reset_form() {
		...
		$('#form-add').attr('action', '<?php echo base_url();?>perahu/save');
		$('#inputan').addClass('sembunyi');
		$('#isi-datane').removeClass('sembunyi');
	...
	function edit_data(id) {
		$('.loading').fadeIn('fast');
		$('#form-add')[0].reset();
		$('#form-add').attr('action', "<?php echo base_url('perahu/update?q=');?>" + id);
		$.ajax({
			url: "<?php echo site_url('perahu/edit')?>",
			type: "POST",
			data: {
				q: id
			},
			...
			success: function(data) {
				$('.loading').fadeOut('fast');
				$('#nama_perahu').val(data.nama_perahu);
				$('#id_kelompok').val(data.id_kelompok).trigger('change');
				$('#lebar_perahu').val(data.lebar_perahu);
				$('#panjang_perahu').val(data.panjang_perahu);
...
//				$('.loading').fadeIn('fast');
				$.ajax({
					url: "<?php echo site_url('perahu/delete')?>",
					type: "POST",
					data: {
						q: x
					},
