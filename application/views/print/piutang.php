...
$pdf->SetTitle( 'Piutang' );
$pdf->SetSubject( 'Piutang' );
$pdf->SetKeywords( 'Piutang' );
...
$content .= 
	'<tr>
		...
		<td class="tebal" width="100" align="right">' . number_format( $total, 0, ',', '.' ) . '</td>
	</tr></tbody></table>';

$pdf->writeHTMLCell( 0, 0, '', '', $content, 0, 1, 0, true, '', true );
ob_clean();
$pdf->Output( 'Piutang.pdf', 'I' );