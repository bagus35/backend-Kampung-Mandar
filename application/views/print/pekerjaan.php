...
$pdf->Image( base_url() . 'aset/img/logo_bojonegoro.png', 10, 12, 15, 0, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false );
...
<thead>
 <tr>
                <th width="60" valign="middle" rowspan="2" >No</th>
                <th width="105" rowspan="2" >Nama Ruas</th>
                <th width="60" rowspan="2" >Kecamatan</th>
                <th width="60" rowspan="2" >Desa/Kelurahan</th>
                <th width="60" rowspan="2" >Status Jalan</th>
                <th width="120" colspan="2" >Kondisi</th>
                <th width="60" rowspan="2" >Panjang<br>
                  <i>(m)</i></th>
                <th width="60" rowspan="2" >Lebar<br>
                  <i>(m)</i></th>
              ...
              <tr>
                <th  width="60" class="v-m-align">Kondisi</th>
                <th  width="60" class="v-m-align">Persen</th>
              </tr>
</thead>
<tbody>';
...
foreach ( $isi as $p ) {
  ...
  $content .=
    '<tr>
		...
		<td width="105">' . $p->nama_ruas . '</td>
		<td width="60" align="right">' . $p->kecamatan . '</td>
		<td width="60" align="right">' . $p->desa . '</td>
		<td width="60" align="right">' . $status_jalan . '</td>
		<td width="60" align="right">' . $p->panjang . '</td>
		<td width="60" align="right">' . $p->lebar . '</td>
		<td width="60" align="right">' . $p->kondisi . '</td>
		<td width="60" align="right">' . $p->persen_kondisi . '</td>
		<td width="60" align="right">' . $p->titik_awal . '</td>
		<td width="60" align="right">' . $p->titik_akhir . '</td>
	</tr>';
}
// BATAS BAWAH ==============================================================
$content .=
