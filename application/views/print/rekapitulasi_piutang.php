...
$pdf->SetTitle( 'Rekapitulasi Piutang' );
$pdf->SetSubject( 'Rekapitulasi Piutang' );
$pdf->SetKeywords( 'Rekapitulasi Piutang' );
...
$pdf->Write( 0, 'REKAPITULASI PIUTANG', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
if($kreditur){
$pdf->SetFont( 'opencondensed', '', 11 );
...
<tr>
<th width="85">NO</th>
<th width="170">KREDITUR</th>
<th width="150">PIUTANG</th>
...
foreach ( $isi as $b ) {
	 ...
	 '<tr>
		...
		<td width="150" align="right">' . number_format( $b['total_piutang'], 0, ',', '.' ) . '</td>
		<td width="150" align="right">' . number_format( $b['total_bayar'], 0, ',', '.' ). '</td>
		<td width="150" align="right">' . number_format( $b['sisa_piutang'], 0, ',', '.' ) . '</td>
	</tr>';
}
// BATAS BAWAH ==============================================================
$content .= 
	'<tr>
		...
		<td class="tebal"  align="right">' . number_format( $total_piutang, 0, ',', '.' ) . '</td>
...
$pdf->setCellPaddings( 0, 0, 0, 0 );
$pdf->SetFont( 'opencondensed', 'B', 16 );
$pdf->Write( 0, 'PIUTANG', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
if($kreditur){
$pdf->SetFont( 'opencondensed', '', 11 );
$pdf->Cell( 15, 4, 'Kreditur', 0, false, 'L', 0, '', 0, false, 'T', 'M' );
...
$content .= 
	'<tr>
		...
		<td class="tebal"  align="right">' . number_format( $ttl_piutang, 0, ',', '.' ) . '</td>
	</tr></tbody></table>';
...
// BATAS ATAS ==========================================
$no=0;
foreach ( $pembayaran_piutang as $b ) {
	$no++;
 	$content .=
	 '<tr>
		<td width="60" align="center">' . $no . '</td>
...
ob_clean();
$pdf->Output( 'Rekapitulasi_piutang.pdf', 'I' );