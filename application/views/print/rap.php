...
$pdf->Write( 0, 'RENCANA ANGGARAN PROYEK', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
$pdf->SetFont( 'opencondensed', '', 11 );
$pdf->Cell( 15, 4, 'Tahun', 0, false, 'L', 0, '', 0, false, 'T', 'M' );
...
<tr>
<th width="60">NO</th>
<th width="245">NAMA PEKERJAAN</th>
<th width="100">NILAI KONTRAK</th>
<th width="100">SP2D</th>
<th width="100">TOTAL RAP</th>
<th width="100">ESTIMASI PENDAPATAN</th>
</tr>
<tr>
<th width="60">A</th>
<th width="245">B</th>
...
foreach ( $isi as $b ) {
	$no++;
	 ...
	 '<tr>
		...
		<td width="100" align="right">' . $b[4] . '</td>
	</tr>';
}
// BATAS BAWAH ==============================================================
$content .= 
