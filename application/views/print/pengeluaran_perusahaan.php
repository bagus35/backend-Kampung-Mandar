...
$pdf->Write( 0, 'PENGELUARAN PERUSAHAAN', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
$pdf->SetFont( 'opencondensed', '', 11 );
...
$pdf->Cell( 4, 4, ':', 0, false, 'C', 0, '', 0, false, 'T', 'M' );
$pdf->Cell( 25, 4, number_format($total_tunai,0,',','.'), 0, false, 'R', 0, '', 0, false, 'T', 'M' );
$pdf->Ln( 5 );
$pdf->Cell( 35, 4, 'Pengeluaran Non Tunai', 0, false, 'L', 0, '', 0, false, 'T', 'M' );
$pdf->Cell( 4, 4, ':', 0, false, 'C', 0, '', 0, false, 'T', 'M' );
$pdf->Cell( 25, 4, number_format($total_non_tunai,0,',','.'), 0, false, 'R', 0, '', 0, false, 'T', 'M' );
$pdf->Ln( 5 );
$pdf->Cell( 35, 4, 'Prive', 0, false, 'L', 0, '', 0, false, 'T', 'M' );
$pdf->Cell( 4, 4, ':', 0, false, 'C', 0, '', 0, false, 'T', 'M' );
$pdf->Cell( 25, 4, number_format($total_prive,0,',','.'), 0, false, 'R', 0, '', 0, false, 'T', 'M' );
$pdf->Ln( 5 );
$pdf->Cell( 35, 4, 'Total Pengeluaran', 0, false, 'L', 0, '', 0, false, 'T', 'M' );
$pdf->Cell( 4, 4, ':', 0, false, 'C', 0, '', 0, false, 'T', 'M' );
$pdf->SetFont( 'opencondensed', 'B', 11 );
$pdf->Cell( 25, 4, number_format($total,0,',','.'), 0, false, 'R', 0, '', 0, false, 'T', 'M' );
$pdf->SetFont( 'opencondensed', '', 11 );
$pdf->Ln( 5 );
...
<div class="ngantuk">
<h3>RINCIAN PENGELUARAN PERUSAHAAN</h3>
<table cellpadding="2">
<thead>
<tr>
<th width="60">No</th>
<th width="100">Tanggal</th>
<th width="445">Uraian</th>
...
$content .= 
	'
	<tr>
		<td width="705" colspan="4"><strong>PENGELUARAN TUNAI</strong></td>
	</tr>';
$no=0;
foreach ( $tunai as $b ) {
	$no++;
...
$content .= 
	...
	<tr>
		...
		<td width="100" align="right"><strong>' . number_format($total_tunai,0,',','.') . '</strong></td>
	</tr>';
$content .= 
	'<tr>
		<td width="705" colspan="4"><strong>PENGELUARAN NON TUNAI</strong></td>
	</tr>';
$no=0;
foreach ( $non as $b ) {
	$no++;
...
$content .= 
	...
	<tr>
		<td colspan="3" align="right"><strong>Total</strong></td>
		<td width="100" align="right"><strong>' . number_format($total_non_tunai,0,',','.') . '</strong></td>
	</tr>';

$content .= 
	'<tr>
		<td width="705" colspan="4"><strong>PRIVE</strong></td>
	</tr>';
...
$content .= 
	...
	<tr>
		<td colspan="3" align="right"><strong>Total</strong></td>
		<td width="100" align="right"><strong>' . number_format($total_prive,0,',','.') . '</strong></td>
	</tr></tbody></table></div>';
$pdf->writeHTMLCell( 0, 0, '', '', $content, 0, 1, 0, true, '', true );
ob_clean();
$pdf->Output( 'pengeluaran_perusahaan.pdf', 'I' );