...
$sp2d = $isi->sp2d;
$target = intval($sp2d) - intval($total);


$pdf->setCellPaddings( 0, 0, 0, 0 );
$pdf->SetFont( 'opencondensed', 'B', 16 );
$pdf->Write( 0, 'RENCANA ANGGARAN BIAYA', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
$pdf->SetFont( 'opencondensed', '', 11 );
...
$content .= 
	...
	<tr>
		...
		<td width="100" align="right"><strong>' . number_format($total,0,',','.') . '</strong></td>
	</tr>
	</tbody></table></div>';
...
ob_clean();
$pdf->Output( 'rap_per_pekerjaan.pdf', 'I' );