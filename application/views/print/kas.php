...
$pdf->Write( 0, 'K A S', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
$pdf->SetFont( 'opencondensed', '', 11 );
...
<table cellpadding="2">
<thead>
<tr style="background-color:#148f77;color:#FFFFFF;vertical-align: middle !important;">
<th width="60">NO</th>
...
$content .= 
	'<tr>
		<td style="background-color:#148f77;color:#FFFFFF;" colspan="3" class="tebal" align="right">SALDO</td>
