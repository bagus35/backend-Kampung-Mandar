...
$pdf->SetTitle( 'Buku Bank' );
$pdf->SetSubject( 'Buku Bank' );
$pdf->SetKeywords( 'Buku Bank' );
...
$pdf->Write( 0, 'BUKU BANK', '', 0, 'C', true, 0, false, false, 0 );
$pdf->Ln( 7 );
$pdf->SetFont( 'opencondensed', '', 11 );
$content = '';
$content .= '
...
<th width="60">NO</th>
<th width="270">NAMA BANK</th>
<th width="125">NO REKENING</th>
<th width="125">ATAS NAMA</th>
<th width="125">SALDO</th>
</tr>
</thead>
<tbody>';
...
foreach ( $isi as $b ) {
	$no++;
	 ...
	 '<tr>
		...
		<td width="125">' . $b[1] . '</td>
		<td width="125">' . $b[2] . '</td>
		<td width="125" align="right">' . $b[3] . '</td>
	</tr>';
}
// BATAS BAWAH ==============================================================
$content .= 
